...
public class Teacher extends Person {
    ...
    private List<Integer> classroomIds; // Lưu ID (Integer) thay vì object Classroom
     ...
     * Logic nghiệp vụ nên nằm trong TeacherService.
     */
    ...
    @Transient // Yêu cầu Hibernate bỏ qua thuộc tính/getter này
    @Override
